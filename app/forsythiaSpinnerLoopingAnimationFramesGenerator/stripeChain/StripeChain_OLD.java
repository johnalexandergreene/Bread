...
public class StripeChain_OLD extends LinkedList<Stripe>{
  ...
  public StripeChain_OLD(FSLAFGenerator generator){
    this.generator=generator;}
  
  public StripeChain_OLD(FSLAFGenerator generator,List<Stripe> stripes){
    this(generator);
    addAll(stripes);}
